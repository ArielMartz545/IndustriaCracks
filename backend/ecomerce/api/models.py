...
class User_puntuation(models.Model):
    evaluated_user_id = models.ForeignKey(Account, related_name="evaluated_user", null=True, on_delete=models.CASCADE, verbose_name='Evaluado')
    evaluator_user_id = models.ForeignKey(Account, related_name="evaluator_user", null=True, on_delete=models.CASCADE, verbose_name='Evaluador')
    points = models.IntegerField(verbose_name='Puntos', null=True)
